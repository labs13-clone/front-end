...
const LandingPageContent = props => {
    ...
    const [classes,
        setClasses] = useState('landing-page__start-btn')
        ...
        <div className="landing-container">
            ...
            <div className="landingContent">
                ...
                <div className="cta testimonials">
                    ...
                    <div className="testimonial-card card-sm">
                        ...
                        <p>Coding is a critical skill in today's world filled with technology, and will
                            also be a valuable skill in the other job market. ChallengeJS is by far the best
                            way to improve your skills!</p>
                    </div>
                    <div className="testimonial-card card-sm">
                        <div>
                        ...
                        <p>ChallengeJS is my favorite site to practice coding challenges. I have learned
                            a lot from completing them.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="content-cards">
                ...
                <div className="about-cards">
                    ...
                    <div className="about-card">
                        <img
                            src="https://media.licdn.com/dms/image/C4E03AQF_qtVBli3p2g/profile-displayphoto-shrink_800_800/0?e=1567036800&v=beta&t=MRN4z4JssJGZl2662nbEQ7ROCR0Mcho3nKZXdEkYUsg"
                            className="about-card__img"/>
